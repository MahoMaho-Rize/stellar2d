...
# via pandoc + xelatex (mirrors docs/mhd_derivations/build_manuscript.sh).
#
# Usage:
...
# 0. Lint the sections for the three structural errors no fixer can handle:
#    unbalanced \boxed{, $$...$$ with a blank line, and CJK characters
#    in formal derivation text (see STYLE_GUIDE.md §2).
echo "→ lint sections/"
...
#    Section order: 00_preamble, a01_..a14_, b01_..b06_,
#                   c01_..c04_, d01_..d07_, e01_..e05_.
