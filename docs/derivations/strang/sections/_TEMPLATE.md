...
>
> **code checkpoints:**
> - `src/gpu/explicit/strang_solver.cu::k_foo`
> - `tests/test_strang_foo.cu`
...
- `tests/test_strang_foo.cu` — which identity is tested, what the
  threshold is, and where the threshold number comes from.
- `tests/test_strang_bar.cu` — ...
...
Template usage rules (see ../STYLE_GUIDE.md for the full rationale):
  1. This file is ENGLISH ONLY.  Formal derivation text must not
     ...
     docs/projects/strang_verification/ benchmark logs, not here.
